...
- [Structure](docs/STRUCTURE.md) - Detailed explanation of the directory layout and sourcing order
- [Customization](docs/CUSTOMIZATION.md) - Guide for adding your own aliases, functions, and configurations
...
The code is available under the [MIT license](.github/LICENSE).
